        ...
        <div class="card-body">
            ...
            <form wire:submit.prevent="save">
                ...
                <table class="table table-sm table-nowrap">
                    ...
                    <tr>
                        <td colspan="7" class="text-center">
                            <button wire:click.prevent="addForm({{$i}})"
                                    class="btn btn-action border-light shadow-none btn-sm waves-effect">
                ...
                <div class="row justify-content-between">
                    <div class="col-md-4">
                        <div class="mb-2">
                            <x-form-textarea label="Keterangan Penjualan" name="internal_notes"
                    ...
                    <div class="col-md-4">
                        <table class="table table-sm table-borderless">
                            ...
                            <tr>
                                <td wire:ignore>
                                    <x-form-select id="potongan" name="potongan" class="form-select form-select-sm"
                                                   data-toggle="select2" data-placeholder="PPh">
                                ...
                                <td class="text-end">
                                    <div class="input-group">
                                        <input wire:model="potongan_nominal" type="text" class="form-control"
                                               placeholder="Potongan" aria-label="Username"
...
@push('scripts')
    <script>
        $('#potongan').on('change', function (event) {
            @this.
            set('potongan', event.target.value)
        })
    </script>
@endpush
