                ...
                <div class="row">
                    <div class="col-md-7">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                <th class="align-middle">Nama Kontak</th>
                                <td class="align-middle">:</td>
                                <td class="align-middle">
                                    <x-form-input name="nick_name" class="border-0 border-bottom" placeholder="Ex: Inova / Abdul Aziz" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">:</td>
                                <td class="align-middle">
                                    <x-form-input name="contact_name" class="border-0 border-bottom" placeholder="Masukan Contact Person" />
                                </td>
                            </tr>
                            <tr>
                                <th>Jenis Kontak</th>
