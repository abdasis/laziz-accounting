...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Aplikasi Akuntansi') }}</title>
                                        ...
                                        <div class="text-center">
                                            <div class="row mt-2">
                                                <div class="col-4">
                                                    ...
                                                    <p class="text-muted font-13 mb-0 text-truncate">
                                                        Total Sales
                                                    </p>
                                                </div>
                                                <div class="col-4">
                                            ...
                                            <div
                                                id="lifetime-sales"
                                                data-colors="#4fc6e1,#6658dd,#ebeff2"
                                                style="height: 270px"
                                                class="morris-chart mt-3"
                                            ></div>
                                        </div>
                                    </div>
                                    <!-- end collapse-->
                            ...
                            <div class="widget-rounded-circle card bg-blue">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <h5 class="mb-1 mt-2 text-white font-16">
                                                Antoine Masson
                                            </h5>
